			...
			while (true) {
				try {
					...
					} else// 오답이면 목숨차감 및 보너스 점수 초기화
					{
						...
						result = dao.insertStd(vo.getUserNo(), vo.getWord(), vo.getKor());
...
//					gm.main(args);
	...
	public static void StartView() {
		System.out.println(
				"____________________________________________________________________________________________________\r\n"
						+ "  _      _      __      ____      _____         _   _     __        __    ______    _____     ____  \r\n"
						+ "  |  |  /     /    )    /    )    /    )        /  /|     / |     /    )    /       /    '    /    )\r\n"
						+ "--|-/|-/-----/----/----/___ /----/----/--------/| /-|----/__|-----\\--------/-------/__-------/___ /-\r\n"
						+ "  |/ |/     /    /    /    |    /    /        / |/  |   /   |      \\      /       /         /    |  \r\n"
						+ "__/__|_____(____/____/_____|___/____/________/__/___|__/____|__(____/____/_______/____ ____/_____|__\r\n"
						+ "\r\n" + "\r\n" + "\r\n" + "	     \r\n" + "\r\n" + "\r\n" + "	 ____ \r\n" + "	||0 ||\r\n"
						+ "	||__|| 시작하기\r\n" + "	|/__\\| 			    	\r\n" + "\r\n" + "	 ____ \r\n"
						+ "	||9 ||\r\n" + "	||__|| 종료하기\r\n" + "	|/__\\| 	\r\n" + "	\r\n"
						+ "____________________________________________________________________________________________________");
...
//						   ModeChoiceView();  
	...
	public static void RankView() {
		...
		ArrayList<VO> arr = dao.rankSelect();
